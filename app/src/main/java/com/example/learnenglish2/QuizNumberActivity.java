...
public class QuizNumberActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadingDialog = new Dialog(QuizNumberActivity.this);
        ...
        firestore.collection("QUIZ").document("CAT" + String.valueOf(category_id))
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task)
            {
                if (task.isSuccessful())
                {
                    ...
                    {
                        Toast.makeText(QuizNumberActivity.this, "No CAT Document Exists..", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                }
                else
                {
                    Toast.makeText(QuizNumberActivity.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if(item.getItemId() == android.R.id.home) {
            QuizNumberActivity.this.finish();
        }
